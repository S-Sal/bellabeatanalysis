...
**The key business task is to reveal opportunities for growth in the smart heath device market.**

The data analyzed if from Kaggle, [FitBit Fitness Tracker Data](https://www.kaggle.com/datasets/arashnic/fitbit).
...
```
Checking columns types and changing to appropriate ones where necessary.
